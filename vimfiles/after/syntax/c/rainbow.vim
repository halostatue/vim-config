...
if g:hlrainbow =~ "[{}]"
 ...
 syn region cCurly1 fold matchgroup=hlLevel1 start='{' end='}' contained contains=@cCurlyGroup,cCurly2
 syn region cCurly2 fold matchgroup=hlLevel2 start='{' end='}' contained contains=@cCurlyGroup,cCurly3
 syn region cCurly3 fold matchgroup=hlLevel3 start='{' end='}' contained contains=@cCurlyGroup,cCurly4
 syn region cCurly4 fold matchgroup=hlLevel4 start='{' end='}' contained contains=@cCurlyGroup,cCurly5
 syn region cCurly5 fold matchgroup=hlLevel5 start='{' end='}' contained contains=@cCurlyGroup,cCurly6
 syn region cCurly6 fold matchgroup=hlLevel6 start='{' end='}' contained contains=@cCurlyGroup,cCurly7
 syn region cCurly7 fold matchgroup=hlLevel7 start='{' end='}' contained contains=@cCurlyGroup,cCurly8
 syn region cCurly8 fold matchgroup=hlLevel8 start='{' end='}' contained contains=@cCurlyGroup,cCurly9
 syn region cCurly9 fold matchgroup=hlLevel9 start='{' end='}' contained contains=@cCurlyGroup,cCurly0
endif
...
if g:hlrainbow =~ "[()]"
 ...
 syn region	cBracket	transparent start='\[\|<::\@!' end=']\|:>' contains=cBlock,cBracket,cCharacter,cComment,cCommentError,cCommentL,cConditional,cConstant,cDefine,cErrInBracket,cInclude,cLabel,cMulti,cNumbers,cOperator,cParen,cPreProc,cRepeat,cSpaceError,cSpecialCharacter,cSpecialError,cStatement,cStorageClass,cString,cStructure,cType
 syn region	cCppBracket	transparent start='\[\|<::\@!' skip='\\$' excludenl end=']\|:>' end='$' contained contains=cBlock,cCharacter,cComment,cCommentError,cCommentL,cConditional,cConstant,cCppBracket,cCppParen,cCppString,cDefine,cErrInBracket,cInclude,cLabel,cMulti,cNumbers,cOperator,cPreProc,cRepeat,cSpaceError,cSpecialCharacter,cSpecialError,cStatement,cStorageClass,cStructure,cType
 " highlighting: {{{2
endif
