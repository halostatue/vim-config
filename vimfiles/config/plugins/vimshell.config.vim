...
autocmd HSAutoCmd FileType vimshell call s:vimshell_settings()
...
autocmd HSAutoCmd FileType int-* call s:interactive_settings()
function! s:interactive_settings()
  call vimshell#hook#set('input', [s:vimshell_hooks.input])
endfunction

autocmd HSAutoCmd FileType term-* call s:terminal_settings()
